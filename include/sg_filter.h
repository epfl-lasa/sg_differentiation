...
public:
  ...
  */
  int Filter(float input, int diff_order, float & output);
  ...
  */
  ...
  int GetOutput(float forward_param,int diff_order, float & output);
  ...
  */
  ...
  int GetOutput(int diff_order, float & output);
  /**
...
public:
  ...
  */
  ...
  int AddData(const Eigen::VectorXf & inp);
  /**
     \brief Compute filtered output. 
  ...
  */
  ...
  int GetOutput(int diff_order, Eigen::VectorXf & result);
  /**
     \brief Compute filtered output. 
  ...
  */
  ...
  int GetOutput(float forward_param, int diff_order, Eigen::VectorXf & result);
  ...
  */
  int Filter(const Eigen::VectorXf & input, int diff_order, Eigen::VectorXf & output);
